...
if options == "Statistik Data Numerik":
    ...
    sns.barplot(x='hr', y='cnt', data=hour_avg, palette='magma')
    ...
    sns.lineplot(x='dteday', y='casual', data=filtered_data_hour, label='Casual', color='blue')
    sns.lineplot(x='dteday', y='registered', data=filtered_data_hour, label='Registered', color='orange')
